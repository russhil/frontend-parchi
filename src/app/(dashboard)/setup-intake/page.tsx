...
export default function SetupIntakePage() {
    ...
    return (
        <div className="max-w-4xl mx-auto p-6">
            <h1 className="text-2xl font-bold text-slate-800 mb-6">Setup Patient Intake</h1>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-6">
                ...
                {!selectedPatient ? (
                    <div className="space-y-4">
                        ...
                        {/* Results */}
                        {results.length > 0 && (
                            <div className="mt-4 border rounded-lg divide-y bg-slate-50 max-h-60 overflow-y-auto">
                                {results.map((r: any) => (
            ...
            {generatedLink && (
                <div className="mt-6 bg-green-50 border border-green-200 rounded-xl p-6 text-center animate-in zoom-in duration-300">
                    ...
                    <div className="flex items-center gap-2 max-w-md mx-auto bg-white border border-green-200 rounded-lg p-2 mb-4">
                        <input
                            readOnly
                            value={generatedLink}
                            className="flex-1 bg-transparent border-none text-sm text-slate-600 outline-none w-full"
                        />
                        <button
                            onClick={copyLink}
